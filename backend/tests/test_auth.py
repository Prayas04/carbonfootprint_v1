...
def test_register_success(client, mocker):
    mocker.patch(
        ...
        return_value=User(id=1, email="test@test.com", full_name="Test User", hashed_password="hashed", role="user")
    )
...
def test_login_success(client, mocker):
    mocker.patch(
        ...
        new_callable=AsyncMock,
        return_value={"access_token": "token", "refresh_token": "refresh", "token_type": "bearer"}
    )
