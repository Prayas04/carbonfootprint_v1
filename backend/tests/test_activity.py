...
def test_get_metrics(client, mocker):
    mocker.patch(
        ...
        return_value={"metrics": [{"label": "Total", "icon": "info", "value": "10", "unit": "kg", "trend": "up", "trend_color": "green"}]}
    )
...
def test_list_events(client, mocker):
    mocker.patch(
        ...
        new_callable=AsyncMock,
        return_value={"data": [], "pagination": {"page": 1, "per_page": 10, "total_items": 0, "total_pages": 0}}
    )
