...
class Transaction(Base):
    ...
    type: Mapped[str] = mapped_column(String(50), nullable=False)  # Settlement | Credit | Bonus | Pending
    amount_tco2e: Mapped[float] = mapped_column(Float, nullable=False)  # Positive=credit, Negative=debit
