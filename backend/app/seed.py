    ...
    async with AsyncSessionLocal() as db:
        ...
        transactions = [
            Transaction(
                ...
                description="🚴 5-day bike streak bonus!",
                type="Achievement",
                amount_tco2e=50.00,
            ),
            Transaction(
                ...
                description="🎯 Monthly carbon goal achieved",
                type="Bonus",
                amount_tco2e=100.00,
            ),
            Transaction(
                ...
                description="🥗 Meatless Monday challenge done",
            ...
            Transaction(
                ...
                description="🚶 Walked to work 3 days",
                type="Achievement",
                amount_tco2e=30.00,
            ),
            Transaction(
            ...
            Transaction(
                ...
                description="⚡ Energy saver challenge done",
                type="Challenge Complete",
                amount_tco2e=20.00,
            ),
            Transaction(
                ...
                description="🚌 Public transit week bonus",
                type="Bonus",
                amount_tco2e=40.00,
            ),
            Transaction(
                ...
                description="🏅 Signed up for CarbonTrack",
                type="Achievement",
                amount_tco2e=10.00,
            ),
            Transaction(
                ...
                description="🚴 Weekend bike ride bonus",
                type="Bonus",
                amount_tco2e=35.00,
            ),
            Transaction(
                ...
                description="🌳 Planted a tree challenge",
                type="Challenge Complete",
                amount_tco2e=50.00,
            ),
        ]
        ...
        green_nodes = [
            GreenNode(
                name="Central Park",
                distance_km=0.8,
                rate_tco2e_per_day=3,
                status="Active",
                latitude=28.6139,
                longitude=77.2090,
            ),
            GreenNode(
                name="City Bike Station",
                distance_km=1.5,
                rate_tco2e_per_day=8,
                status="Active",
                latitude=28.6280,
                longitude=77.2190,
            ),
